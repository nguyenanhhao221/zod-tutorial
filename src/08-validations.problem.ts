...
const Form = z.object({
  name: z.string().min(1), //cannot pass string with less than 1 character
  //             ^ 🕵️‍♂️
  phoneNumber: z.string().min(5).max(20).optional(), //min 5 char, max 20 char
  //                    ^ 🕵️‍♂️
  email: z.string().email(), //need to be valid email
  //              ^ 🕵️‍♂️
  website: z.string().url().optional(), //need to be valid url (website)
  //                ^ 🕵️‍♂️
});
